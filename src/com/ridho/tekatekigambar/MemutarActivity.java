...
public class MemutarActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_memutar);
	...
	boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.memutar, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(),OtakActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
