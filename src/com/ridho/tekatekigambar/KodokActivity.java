...
public class KodokActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kodok, menu);
		return true;
	}
	public void cekJawaban(View v){
    	String jawabanBenar = "KODOK TERBANG";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),MemutarActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
