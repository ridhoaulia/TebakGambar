...
public class JanganActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_jangan);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jangan, menu);
		return true;
	}
	public void cekJawaban(View v){
    	String jawabanBenar = "JANGAN SUKA PAKSAKAN BILA TAK BERUSAHA SEKUAT TENAGA";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),ObesitassActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
