...
public class DonaturresmiActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_donaturresmi);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.donaturresmi, menu);
		return true;
	}
	public void cekJawaban(View v){
    	String jawabanBenar = "DONATUR RESMI";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),JejakatakutActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
