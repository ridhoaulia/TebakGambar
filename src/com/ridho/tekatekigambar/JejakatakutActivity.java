...
public class JejakatakutActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_jejakatakut);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jejakatakut, menu);
		return true;
	}
	public void cekJawaban(View v){
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),KodokActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
