...
public class OtakActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.otak, menu);
		return true;
	}
	public void cekJawaban(View v){
    	String jawabanBenar = "OTAKMU MIRING";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(),PenyusutanActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
